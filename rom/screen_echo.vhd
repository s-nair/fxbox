...
-- Module  Version: 5.4
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n screen_echo -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 00 -rp 1100 -addr_width 7 -data_width 8 -num_rows 128 -cascade -1 -memfile c:/fpga/projects/fxbox/rom/mem/screen_echo_rom.mem -memformat hex -init_data DYNAMIC 
...
architecture Structure of screen_echo is
    ...
    attribute MEM_LPC_FILE of screen_echo_0_0_0 : label is "screen_echo.lpc";
    attribute MEM_INIT_FILE of screen_echo_0_0_0 : label is "screen_echo_rom.mem";
...
begin
    ...
    screen_echo_0_0_0: DP8KC
        ...
        INITVAL_01=> "0x0B87C040200402009E480864504020040200F82F0402004020040200402004020040200402004020", 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of screen_echo is
    for Structure
