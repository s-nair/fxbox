...
set ::bali::simulation::Para(PROJECT) {adc_controller_sim}
set ::bali::simulation::Para(PROJECTPATH) {C:/fpga/projects/FxBox}
set ::bali::simulation::Para(FILELIST) {"C:/fpga/projects/FxBox/src/pkg/fxbox_pkg.vhd" "C:/fpga/projects/FxBox/adc_controller.vhd" "C:/fpga/projects/FxBox/adc_controller_tb.vhd" }
