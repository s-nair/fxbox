...
-- Module  Version: 5.7
--C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n sclk_pll -lang vhdl -synth lse -arch xo2c00 -type pll -fin 7 -mdiv 1 -ndiv 2 -trimp 0 -phasep 0 -trimp_r -adiv 33 -trims 0 -phases 0 -trims_r -bdiv 99 -phase_cntl STATIC -enable_ports -rst -fb_mode 1 -lock -fracn 41494 
...
architecture Structure of sclk_pll is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "6.144012";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "18.432037";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "7.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  98, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  32, 
        PLL_LOCK_MODE=>  0, CLKOS_TRIM_DELAY=>  0, CLKOS_TRIM_POL=> "RISING", 
        CLKOP_TRIM_DELAY=>  0, CLKOP_TRIM_POL=> "RISING", FRACN_DIV=>  41494, 
        ...
        CLKOS_DIV=>  99, CLKOP_DIV=>  33, CLKFB_DIV=>  2, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of sclk_pll is
    for Structure
