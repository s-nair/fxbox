...
set ::bali::simulation::Para(PROJECT) {i2s_slave_sim}
set ::bali::simulation::Para(PROJECTPATH) {C:/fpga/projects/FxBox}
set ::bali::simulation::Para(FILELIST) {"C:/fpga/projects/FxBox/src/pkg/fxbox_pkg.vhd" "C:/fpga/projects/FxBox/i2s_slave.vhd" "C:/fpga/projects/FxBox/i2s_slave_tb.vhd" }
